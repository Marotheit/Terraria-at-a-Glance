$(document).ready(function(){
	$('#show_build_button').click(function(){
		...
		.fail(function (err){
			$('#relevant_build').html("<div id=\"sorry\">Sorry!</div><div id=\"not_found\">It seems like this guide hasn't been implemented quite yet!<br/><br/>Please check back later, or, if you're feeling adventurous, <a href=\"https://github.com/Marotheit/Terraria-at-a-Glance/wiki/Creating-a-Build">feel free to write it yourself!</a></div>");
			$('#relevant_build').css("display", "block");
		});
	});
});
